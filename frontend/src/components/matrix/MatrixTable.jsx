...
import { RowRenderer } from './formatting'
...
const Table = ({ cellSelect, rowSelect }) => {
    const [filters, setFilters] = useState({});
    const dispatch = useDispatch();
    let data = useSelector(state => state.data.matrixFormatted);
        ...
        return (
            <ReactDataGrid
                ...
                onGridSort={(sortColumn, sortDirection) => {
                    ...
                    _data.rows = sorted;
                    dispatch(dataSlice.actions.setMatrix(_data));
                }
